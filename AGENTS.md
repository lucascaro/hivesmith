...
- **Lint:** `shellcheck install.sh skills/feature-ingest/ingest.sh templates/features/ingest.sh templates/scripts/release.sh` (mirrors `.github/workflows/ci.yml` shellcheck job).
