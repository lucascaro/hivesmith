...
| P2 | #35 | Make plan-html the default in feature-loop and add per-section feedback boxes | IMPLEMENT | [035-plan-html-default-and-per-section-feedback](035-plan-html-default-and-per-section-feedback.md) |
