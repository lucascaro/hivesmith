...
| P2 | #24 | Add plan-first starting point to hs-feature-loop | IMPLEMENT | [024-plan-first-starting-point-for-feature-loop](024-plan-first-starting-point-for-feature-loop.md) |
